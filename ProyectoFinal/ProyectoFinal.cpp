...
void ShowRute(Graph pMap, const char* pPath, int pStart, int pEnd)
{
    ...
    stbi_write_png("C:/PyED_Aux/MazeSolved.png", Width, Height, CHANNEL_NUM, Maze_Img, Width * CHANNEL_NUM);
...
{
    //Path
    const char* path = "C:/PyED_Aux/Lab01.png";

    Graph Mapa = Laberinto(path);
    ShowRute(Mapa, path, 0, 923);
}